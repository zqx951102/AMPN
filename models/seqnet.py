...
class SeqNet(nn.Module):
    def __init__(self, cfg):
        ...
        rpn = RegionProposalNetwork(
            ...
            pre_nms_top_n=pre_nms_top_n, #12000 6000
            post_nms_top_n=post_nms_top_n,#2000 300
            nms_thresh=cfg.MODEL.RPN.NMS_THRESH,  #NMS threshold used on RoIs 0.7
        )
...
class SeqRoIHeads(RoIHeads):
    ...
    def postprocess_boxes(
        ...
        if fcs is not None:
            ...
            pred_scores = torch.sigmoid(class_logits)  # box_cls_scores,
        if cws:
